...
import { TIMEOUT } from "@test-data/constants";
...
export class ElementAssertions {
  ...
  static async toBeVisible(
    ...
    const { timeout = TIMEOUT, message } = options;
    logger.debug(
...
export class TextAssertions {
  ...
  static async toHaveText(
    ...
    const { timeout = TIMEOUT, ignoreCase, message } = options;
...
export class InputAssertions {
  ...
  static async toBeChecked(
    ...
    const { timeout = TIMEOUT, checked, message } = options;
